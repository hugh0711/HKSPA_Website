            ...
            Else
                ...
                Try
                    ...
                    If User Is Nothing Then
                        String.Format("Invalid Url or activation code. Please check the email and try again or contact our customer service <a href='mailto:{0}'>{0}</a>", ConfigurationManager.AppSettings("EnquiryEmail"))
                    ElseIf User.IsApproved Then
                        String.Format("This user is already activated. Please check the email and try again or contact our customer service <a href='mailto:{0}'>{0}</a>", ConfigurationManager.AppSettings("EnquiryEmail"))
                    Else
