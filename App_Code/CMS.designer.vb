...
Partial Public Class AlbumPhoto_info
	...
	Private _aperture As String
	
	Private _shutter As String
	
	Private _Facebook_photoID As String
    ...
    End Sub
    Partial Private Sub OnapertureChanging(value As String)
    End Sub
    Partial Private Sub OnapertureChanged()
    End Sub
    Partial Private Sub OnshutterChanging(value As String)
    End Sub
    Partial Private Sub OnshutterChanged()
    End Sub
    Partial Private Sub OnFacebook_photoIDChanging(value As String)
    End Sub
    Partial Private Sub OnFacebook_photoIDChanged()
    End Sub
    #End Region
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_aperture", DbType:="NVarChar(50)")>  _
	Public Property aperture() As String
		Get
			Return Me._aperture
		End Get
		Set
			If (String.Equals(Me._aperture, value) = false) Then
				Me.OnapertureChanging(value)
				Me.SendPropertyChanging
				Me._aperture = value
				Me.SendPropertyChanged("aperture")
				Me.OnapertureChanged
			End If
		End Set
	End Property
	
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_shutter", DbType:="NVarChar(50)")>  _
	Public Property shutter() As String
		Get
			Return Me._shutter
		End Get
		Set
			If (String.Equals(Me._shutter, value) = false) Then
				Me.OnshutterChanging(value)
				Me.SendPropertyChanging
				Me._shutter = value
				Me.SendPropertyChanged("shutter")
				Me.OnshutterChanged
			End If
		End Set
	End Property
	
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_Facebook_photoID", DbType:="NVarChar(100)")>  _
	Public Property Facebook_photoID() As String
		Get
			Return Me._Facebook_photoID
		End Get
		Set
			If (String.Equals(Me._Facebook_photoID, value) = false) Then
				Me.OnFacebook_photoIDChanging(value)
				Me.SendPropertyChanging
				Me._Facebook_photoID = value
				Me.SendPropertyChanged("Facebook_photoID")
				Me.OnFacebook_photoIDChanged
			End If
		End Set
	End Property
