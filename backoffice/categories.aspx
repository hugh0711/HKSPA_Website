    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MySqlConnection %>"
                ...
                SelectCommand="SELECT [CategoryID], [Category],[CategoryName], [ParentID], [SortOrder], [Enabled], [Url], [FunctionID] FROM [view_Category] WHERE ([ParentID] = @ParentID) AND [Lang] = @Lang and [FunctionID] = @FunctionID ORDER BY [SortOrder]" 
                        ...
                        <table border="0" width="100%">
                            <tr>
                                <td width="60%" valign="top">
                                    ...
                                    <%--<asp:Label runat="server" ID="lblCategory" Text='<%# Eval("Category").ToString() %>' Font-Strikeout='<%# Not Eval("Enabled") %>'></asp:Label>--%>
                                ...
                                <td valign="top" nowrap="nowrap">
                                    ...
                                    <asp:HyperLink runat="server" ID="HyperLink2" Text='<%# GetProduct() %>' NavigateUrl='<%# String.Format("~/backoffice/products.aspx?category={0}&fn={1}", Eval("CategoryID"), Eval("FunctionID")) %>' Visible='<%# IsShowEpisode() %>'></asp:HyperLink>
                                </td>
                            </tr>
                        </table>
                </ItemTemplate>
                    ...
                    <table border="0" width="100%">
                        <tr>
                            <td width="50%" valign="top">
                                ...
                                <asp:TextBox runat="server" ID="txtCategory" Text='<%# Bind("Category") %>' Width="85%" />
                            </td>
                ...
                <InsertItemTemplate>
                    <table border="0" width="100%" bgcolor="#dddddd">
                        <tr>
                            <td width="20">&nbsp;</td>
                            <td width="50%" valign="top">
                                <asp:TextBox runat="server" ID="txtCategory" Text='<%# Bind("Category") %>' Columns="30" Width="95%" />
                            </td>
                            <td width="10%" valign="top">
                                <asp:CheckBox runat="server" ID="chkEnabled" Checked='<%# Bind("Enabled") %>' Text="使用" />
                            </td>
