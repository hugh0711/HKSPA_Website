...
Partial Class backoffice_user
    ...
    Protected Sub SaveData()
        ...
        If chkNew.Checked Then
            ...
            MemberAdaptor.Insert(Username, rblGender.SelectedValue, txtDisplayName.Text, txtEmail.Text, ContactNumber, txtDeliveryAddress.Text, radCountry.SelectedValue, Birthday, DateTime.Now, "")
        Else
			...
			End If
            MemberAdaptor.Update(Username, rblGender.SelectedValue, txtDisplayName.Text, txtEmail.Text, ContactNumber, txtDeliveryAddress.Text, radCountry.SelectedValue, Birthday, Utility.StringToDateTime(lblCreationDate.Text), txtFacebookID.Text, Username)
		End If
