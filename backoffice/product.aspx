                            ...
                            <td>
                                ...
                                <asp:Panel runat="server" ID="pnlCategory" CssClass="modalPopup" style="display:none;" >
                                    ...
                                    <div style="overflow: auto;">
                                        <asp:TreeView ID="TreeView1" runat="server" ClientIDMode="AutoID" ExpandDepth="1" Width="250" Height="250" EnableClientScript="true"> 
                                            <Nodes>
            ...
            <asp:PlaceHolder runat="server" ID="phdDetails2" Visible="false">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <br />
                        <asp:CheckBox ID="chkUploadFacebook" runat="server" Text="Publish to Facebook" Checked="false" Visible="false" />
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnSave" runat="server" Text="Update" ValidationGroup="gp1" />
