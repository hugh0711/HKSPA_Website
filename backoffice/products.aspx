...
<%--            <asp:RadioButtonList runat="server" ID="rblCategory" RepeatDirection="Horizontal">
            ...
            <asp:SqlDataSource ID="SqlDataSourceAll" runat="server" ConnectionString="<%$ ConnectionStrings:MySqlConnection %>"
                ...
                SelectCommand="SELECT ProductID, ProductCode, ProductName, CategoryName, Url, Enabled, SortOrder, ThumbnailWidth, ThumbnailHeight, Description FROM view_ProductImage WHERE (Lang = @Lang) AND (FunctionID = @FunctionID) ORDER BY CategoryID, SortOrder" 
                UpdateCommand="UPDATE Product SET SortOrder = @SortOrder WHERE (ProductID = @ProductID)" 
                DeleteCommand="DELETE FROM Product WHERE (ProductID = @ProductID)">
                ...
                <ItemTemplate>
                    <table border="0" cellpadding="0" cellspacing="0" width="95%">
                        <tr>
                            ...
                            <td align="right">
                                <asp:Button runat="server" ID="btnEdit" Text="編緝" UseSubmitBehavior="false" CommandName="edit1" CommandArgument='<%# Eval("ProductID") %>' Width="60" />
                                <br />
                                <asp:Button runat="server" ID="btnDelete" Text="刪除" UseSubmitBehavior="false" CommandName="delete1" CommandArgument='<%# Eval("ProductID") %>' Width="60" />
