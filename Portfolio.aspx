      ...
      <div class="container">
        <h1 id="folio-headline">
          ...
          <asp:SqlDataSource runat="server" ID="dsFeature" 
                ...
                SelectCommand="SELECT [CategoryName],[Url],[CategoryID],[FunctionID],[Lang] FROM [view_Category] WHERE ([Enabled] = @Enabled) and [ParentID]= @CategoryID and [Lang]=@Lang ORDER BY [SortOrder]">
