...
var TITLE_LABEL = "uzbek_cyrrilic";
...
/*********************************************************************/
	if(keyBoardType==0){	
		if(gubun == 'lang'){		
			...
			setKeyText("wkk_key_51", "э");
			setKeyText("wkk_key_52", "ю");
			setKeyText("wkk_key_53", "я");
			setKeyText("wkk_key_54", "ў");
			setKeyText("wkk_key_55", "қ");
			setKeyText("wkk_key_56", "ғ");
			setKeyText("wkk_key_57", "ҳ");     
		}else if(gubun == 'sl')	{
			switch(stIdx){		
				case 10:
					stIdx = 11;
	...
	/*********************************************************************/
		...
		if(gubun == 'lang'){	
			...
			setKeyText("wkk_key_35", "ч");
			setKeyText("wkk_key_40", "ш");
			setKeyText("wkk_key_41", "ъ");
			setKeyText("wkk_key_42", "ь");
			setKeyText("wkk_key_43", "э");
			setKeyText("wkk_key_44", "ю");
			setKeyText("wkk_key_45", "я");
			setKeyText("wkk_key_50", "ў");
			setKeyText("wkk_key_51", "қ");
			setKeyText("wkk_key_52", "ғ");
			setKeyText("wkk_key_53", "ҳ");	
		}else	if(gubun == 'sl')	{
			switch(stIdx){
				case 10:
					stIdx = 11;
...
/*********************************************************************/
	...
	/*********************************************************************/	
		...
		if(gubun == 'lang'){	
			...
			setKeyText("wkk_key_111", "ч");
			setKeyText("wkk_key_112", "ш");
			setKeyText("wkk_key_113", "ъ");
			setKeyText("wkk_key_201", "ь");
			setKeyText("wkk_key_202", "э");
			setKeyText("wkk_key_203", "ю");
			setKeyText("wkk_key_204", "я");
			setKeyText("wkk_key_210", "ў"); 
			setKeyText("wkk_key_211", "қ"); 
			setKeyText("wkk_key_212", "ғ"); 
			setKeyText("wkk_key_213", "ҳ");	
		}else if(gubun == 'sl')	{
			switch(stIdx){
			case 10:
				stIdx = 11;
