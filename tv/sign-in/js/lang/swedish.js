...
function initialize() {
	...
	if(keyBoardType==0){
		miniPopUpInfoObjects[0] = getPopUPInfoObject("11", "wkk_key_00", "05", new Array("a","à","ä","å"), new Array("00","01","02","03","04","05"), null, "04");
		miniPopUpInfoObjects[1] = getPopUPInfoObject("10", "wkk_key_00", "05", new Array('A','À','Ä','Å'), new Array("00","01","02","03","04","05"), null, "04");
		...
		miniPopUpInfoObjects[0] = getPopUPInfoObject("11", "wkk_key_001", "05", new Array("a","à","ä","å"), new Array("00","01","02","03","04","05"), null, "04");
		miniPopUpInfoObjects[1] = getPopUPInfoObject("10", "wkk_key_001", "05", new Array('A','À','Ä','Å'), new Array("00","01","02","03","04","05"), null, "04");
...
if(keyBoardType==0){	
		if(gubun == 'lang'){	
		  ...
		  setInnerHtml("wkk_key_62", 'ABC');
			...
			setInnerHtml("wkk_key_61", "SWE");	//Lang Toggle
	...
	/*********************************************************************/	
		...
		if(gubun == 'lang'){
			...
			setInnerHtml("wkk_key_116", "SWE");	//Lang Toggle
