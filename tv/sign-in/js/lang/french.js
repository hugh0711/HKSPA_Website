...
function initialize() {
	...
	if(keyBoardType==0){
		miniPopUpInfoObjects[0] = getPopUPInfoObject("11", "wkk_key_00", "05", new Array('a','à','â','æ'), new Array("00","01","02","03"), null, "04");
		miniPopUpInfoObjects[1] = getPopUPInfoObject("10", "wkk_key_00", "05", new Array('A','À','Â','Æ'), new Array("00","01","02","03"), null, "04");
		miniPopUpInfoObjects[2] = getPopUPInfoObject("11", "wkk_key_02", "04", new Array('c','ç'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[3] = getPopUPInfoObject("10", "wkk_key_02", "04", new Array('C','Ç'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[4] = getPopUPInfoObject("11", "wkk_key_04", "03", new Array('e','è','é','ê','ë'), new Array("00","01","02","10","11"), null, "12");
		miniPopUpInfoObjects[5] = getPopUPInfoObject("10", "wkk_key_04", "03", new Array('E','È','É','Ê','Ë'), new Array("00","01","02","10","11"), null, "12");
		miniPopUpInfoObjects[6] = getPopUPInfoObject("11", "wkk_key_13", "02", new Array('i','î','ï'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[7] = getPopUPInfoObject("10", "wkk_key_13", "02", new Array('I','Î','Ï'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[8] = getPopUPInfoObject("11", "wkk_key_23", "04", new Array('n','ñ'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[9] = getPopUPInfoObject("10", "wkk_key_23", "04", new Array('N','Ñ'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[10] = getPopUPInfoObject("11", "wkk_key_24", "02", new Array('o','ô','œ'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[11] = getPopUPInfoObject("10", "wkk_key_24", "02", new Array('O','Ô','Œ'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[12] = getPopUPInfoObject("11", "wkk_key_40", "02", new Array('u','ù','û'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[13] = getPopUPInfoObject("10", "wkk_key_40", "02", new Array('U','Ù','Û'), new Array("00","01","02"), null, "03");
		...
		miniPopUpInfoObjects[4] = getPopUPInfoObject("11", "wkk_key_04", "03", new Array('e','è','é','ê','ë'), new Array("00","01","02","10","11"), null, "12");
		miniPopUpInfoObjects[5] = getPopUPInfoObject("10", "wkk_key_04", "03", new Array('E','È','É','Ê','Ë'), new Array("00","01","02","10","11"), null, "12");
		miniPopUpInfoObjects[6] = getPopUPInfoObject("11", "wkk_key_12", "02", new Array('i','î','ï'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[7] = getPopUPInfoObject("10", "wkk_key_12", "02", new Array('I','Î','Ï'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[8] = getPopUPInfoObject("11", "wkk_key_21", "04", new Array('n','ñ'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[9] = getPopUPInfoObject("10", "wkk_key_21", "04", new Array('N','Ñ'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[10] = getPopUPInfoObject("11", "wkk_key_22", "02", new Array('o','ô','œ'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[11] = getPopUPInfoObject("10", "wkk_key_22", "02", new Array('O','Ô','Œ'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[12] = getPopUPInfoObject("11", "wkk_key_32", "02", new Array('u','ù','û'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[13] = getPopUPInfoObject("10", "wkk_key_32", "02", new Array('U','Ù','Û'), new Array("00","01","02"), null, "03");
	} else {
		miniPopUpInfoObjects[0] = getPopUPInfoObject("11", "wkk_key_001", "05", new Array('a','à','â','æ'), new Array("00","01","02","03"), null, "04");
		miniPopUpInfoObjects[1] = getPopUPInfoObject("10", "wkk_key_001", "05", new Array('A','À','Â','Æ'), new Array("00","01","02","03"), null, "04");
		miniPopUpInfoObjects[2] = getPopUPInfoObject("11", "wkk_key_003", "04", new Array('c','ç'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[3] = getPopUPInfoObject("10", "wkk_key_003", "04", new Array('C','Ç'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[4] = getPopUPInfoObject("11", "wkk_key_005", "03", new Array('e','è','é','ê','ë'), new Array("00","01","02","03","04"), null, "05");
		miniPopUpInfoObjects[5] = getPopUPInfoObject("10", "wkk_key_005", "03", new Array('E','È','É','Ê','Ë'), new Array("00","01","02","03","04"), null, "05");
		miniPopUpInfoObjects[6] = getPopUPInfoObject("11", "wkk_key_009", "02", new Array('i','î','ï'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[7] = getPopUPInfoObject("10", "wkk_key_009", "02", new Array('I','Î','Ï'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[8] = getPopUPInfoObject("11", "wkk_key_101", "04", new Array('n','ñ'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[9] = getPopUPInfoObject("10", "wkk_key_101", "04", new Array('N','Ñ'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[10] = getPopUPInfoObject("11", "wkk_key_102", "02", new Array('o','ô','œ'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[11] = getPopUPInfoObject("10", "wkk_key_102", "02", new Array('O','Ô','Œ'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[12] = getPopUPInfoObject("11", "wkk_key_108", "02", new Array('u','ù','û'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[13] = getPopUPInfoObject("10", "wkk_key_108", "02", new Array('U','Ù','Û'), new Array("00","01","02"), null, "03");
	}
...
if(keyBoardType==0){	
		if(gubun == 'lang'){	
		  ...
		  setInnerHtml("wkk_key_62", 'ABC');
			...
			setInnerHtml("wkk_key_61", "FRE");	//Lang Toggle
	...
	/*********************************************************************/	
		...
		if(gubun == 'lang'){
			...
			setInnerHtml("wkk_key_116", "FRE");	//Lang Toggle
