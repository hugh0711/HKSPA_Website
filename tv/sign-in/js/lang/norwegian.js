...
function initialize() {
		...
		document.getElementById("wkk_tx").style.textAlign= 'left';
			if(keyBoardType == 0 ) { 
					miniPopUpInfoObjects[0] = getPopUPInfoObject("11", "wkk_key_00", "05", new Array('a','à','å','æ'), new Array("00","01","02","03"), null, "04");
					miniPopUpInfoObjects[1] = getPopUPInfoObject("10", "wkk_key_00", "05", new Array('A','À','Å','Æ'), new Array("00","01","02","03"), null, "04");
					miniPopUpInfoObjects[2] = getPopUPInfoObject("11", "wkk_key_04", "02", new Array('e','é','ê'), new Array("00","01","02"), null, "03");
					miniPopUpInfoObjects[3] = getPopUPInfoObject("10", "wkk_key_04", "02", new Array('E','É','Ê'), new Array("00","01","02"), null, "03");
					miniPopUpInfoObjects[4] = getPopUPInfoObject("11", "wkk_key_24", "03", new Array('o','ò','ó','ô','ø'), new Array("00","01","02","10","11"), null, "12");
					miniPopUpInfoObjects[5] = getPopUPInfoObject("10", "wkk_key_24", "03", new Array('O','Ò','Ó','Ô','Ø'), new Array("00","01","02","10","11"), null, "12");
			}else if(keyBoardType == 1){
					miniPopUpInfoObjects[0] = getPopUPInfoObject("11", "wkk_key_00", "05", new Array('a','à','å','æ'), new Array("00","01","02","03"), null, "04");
					miniPopUpInfoObjects[1] = getPopUPInfoObject("10", "wkk_key_00", "05", new Array('A','À','Å','Æ'), new Array("00","01","02","03"), null, "04");
					miniPopUpInfoObjects[2] = getPopUPInfoObject("11", "wkk_key_04", "02", new Array('e','é','ê'), new Array("00","01","02"), null, "03");
					miniPopUpInfoObjects[3] = getPopUPInfoObject("10", "wkk_key_04", "02", new Array('E','É','Ê'), new Array("00","01","02"), null, "03");
					miniPopUpInfoObjects[4] = getPopUPInfoObject("11", "wkk_key_22", "03", new Array('o','ò','ó','ô','ø'), new Array("00","01","02","10","11"), null, "12");
					miniPopUpInfoObjects[5] = getPopUPInfoObject("10", "wkk_key_22", "03", new Array('O','Ò','Ó','Ô','Ø'), new Array("00","01","02","10","11"), null, "12");
			}else{
					miniPopUpInfoObjects[0] = getPopUPInfoObject("11", "wkk_key_001", "05", new Array('a','à','å','æ'), new Array("00","01","02","03"), null, "04");
					miniPopUpInfoObjects[1] = getPopUPInfoObject("10", "wkk_key_001", "05", new Array('A','À','Å','Æ'), new Array("00","01","02","03"), null, "04");
					miniPopUpInfoObjects[2] = getPopUPInfoObject("11", "wkk_key_005", "02", new Array('e','é','ê'), new Array("00","01","02"), null, "03");
					miniPopUpInfoObjects[3] = getPopUPInfoObject("10", "wkk_key_005", "02", new Array('E','É','Ê'), new Array("00","01","02"), null, "03");
					miniPopUpInfoObjects[4] = getPopUPInfoObject("11", "wkk_key_102", "03", new Array('o','ò','ó','ô','ø'), new Array("00","01","02","03","04"), null, "05");
					miniPopUpInfoObjects[5] = getPopUPInfoObject("10", "wkk_key_102", "03", new Array('O','Ò','Ó','Ô','Ø'), new Array("00","01","02","03","04"), null, "05");
			}
	...
	if(keyBoardType==0){	
		if(gubun == 'lang'){	
		  ...
		  setInnerHtml("wkk_key_62", 'ABC');
			...
			setInnerHtml("wkk_key_61", "NOR");	//Lang Toggle
...
/*********************************************************************/
	...
	/*********************************************************************/	
		...
		if(gubun == 'lang'){
			...
			setInnerHtml("wkk_key_116", "NOR");	//Lang Toggle
