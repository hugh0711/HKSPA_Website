...
function initialize() {
	...
	if(keyBoardType==0){
		miniPopUpInfoObjects[0] = getPopUPInfoObject("11", "wkk_key_00", "04", new Array('a','à'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[1] = getPopUPInfoObject("10", "wkk_key_00", "04", new Array('A','À'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[2] = getPopUPInfoObject("11", "wkk_key_04", "02", new Array('e','è','é'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[3] = getPopUPInfoObject("10", "wkk_key_04", "02", new Array('E','È','É'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[4] = getPopUPInfoObject("11", "wkk_key_13", "05", new Array('i','ì','í','ï'), new Array("00","01","02","03"), null, "04");
		miniPopUpInfoObjects[5] = getPopUPInfoObject("10", "wkk_key_13", "05", new Array('I','Ì','Í','Ï'), new Array("00","01","02","03"), null, "04");
		miniPopUpInfoObjects[6] = getPopUPInfoObject("11", "wkk_key_24", "02", new Array('o','ò','ó'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[7] = getPopUPInfoObject("10", "wkk_key_24", "02", new Array('O','Ò','Ó'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[8] = getPopUPInfoObject("11", "wkk_key_40", "02", new Array('u','ù','ú'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[9] = getPopUPInfoObject("10", "wkk_key_40", "02", new Array('U','Ù','Ú'), new Array("00","01","02"), null, "03");
	}  else if(keyBoardType==1){
		miniPopUpInfoObjects[0] = getPopUPInfoObject("11", "wkk_key_00", "04", new Array('a','à'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[1] = getPopUPInfoObject("10", "wkk_key_00", "04", new Array('A','À'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[2] = getPopUPInfoObject("11", "wkk_key_04", "02", new Array('e','è','é'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[3] = getPopUPInfoObject("10", "wkk_key_04", "02", new Array('E','È','É'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[4] = getPopUPInfoObject("11", "wkk_key_12", "05", new Array('i','ì','í','ï'), new Array("00","01","02","03"), null, "04");
		miniPopUpInfoObjects[5] = getPopUPInfoObject("10", "wkk_key_12", "05", new Array('I','Ì','Í','Ï'), new Array("00","01","02","03"), null, "04");
		miniPopUpInfoObjects[6] = getPopUPInfoObject("11", "wkk_key_22", "02", new Array('o','ò','ó'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[7] = getPopUPInfoObject("10", "wkk_key_22", "02", new Array('O','Ò','Ó'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[8] = getPopUPInfoObject("11", "wkk_key_32", "02", new Array('u','ù','ú'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[9] = getPopUPInfoObject("10", "wkk_key_32", "02", new Array('U','Ù','Ú'), new Array("00","01","02"), null, "03");
	} else{
		miniPopUpInfoObjects[0] = getPopUPInfoObject("11", "wkk_key_001", "04", new Array('a','à'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[1] = getPopUPInfoObject("10", "wkk_key_001", "04", new Array('A','À'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[2] = getPopUPInfoObject("11", "wkk_key_005", "02", new Array('e','è','é'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[3] = getPopUPInfoObject("10", "wkk_key_005", "02", new Array('E','È','É'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[4] = getPopUPInfoObject("11", "wkk_key_009", "05", new Array('i','ì','í','ï'), new Array("00","01","02","03"), null, "04");
		miniPopUpInfoObjects[5] = getPopUPInfoObject("10", "wkk_key_009", "05", new Array('I','Ì','Í','Ï'), new Array("00","01","02","03"), null, "04");
		miniPopUpInfoObjects[6] = getPopUPInfoObject("11", "wkk_key_102", "02", new Array('o','ò','ó'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[7] = getPopUPInfoObject("10", "wkk_key_102", "02", new Array('O','Ò','Ó'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[8] = getPopUPInfoObject("11", "wkk_key_108", "02", new Array('u','ù','ú'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[9] = getPopUPInfoObject("10", "wkk_key_108", "02", new Array('U','Ù','Ú'), new Array("00","01","02"), null, "03");
	}
}
...
function changeKeyValue(gubun) {
	...
	if(keyBoardType==0){	
		if(gubun == 'lang'){	
		  ...
		  setInnerHtml("wkk_key_62", 'ABC');
			...
			setInnerHtml("wkk_key_61", "ITA");	//Lang Toggle
	...
	/*********************************************************************/	
		...
		if(gubun == 'lang'){
			...
			setInnerHtml("wkk_key_116", "ITA");	//Lang Toggle
