...
function initialize() {
		...
		if(keyBoardType == 0 ) {
			...
			miniPopUpInfoObjects[2] = getPopUPInfoObject("11", "wkk_key_04", "04", new Array('e','ë'), new Array("00","01"), null, "02");
			miniPopUpInfoObjects[3] = getPopUPInfoObject("10", "wkk_key_04", "04", new Array('E','Ë'), new Array("00","01"), null, "02");
			...
			miniPopUpInfoObjects[2] = getPopUPInfoObject("11", "wkk_key_005", "04", new Array('e','ë'), new Array("00","01"), null, "02");
			miniPopUpInfoObjects[3] = getPopUPInfoObject("10", "wkk_key_005", "04", new Array('E','Ë'), new Array("00","01"), null, "02");
		}
}
	...
	if(keyBoardType==0){	
		if(gubun == 'lang'){	
		  ...
		  setInnerHtml("wkk_key_62", 'ABC');
			...
			setInnerHtml("wkk_key_61", "ALB");	//Lang Toggle
...
/*********************************************************************/
	...
	/*********************************************************************/	
		...
		if(gubun == 'lang'){
			...
			setInnerHtml("wkk_key_116", "ALB");	//Lang Toggle
