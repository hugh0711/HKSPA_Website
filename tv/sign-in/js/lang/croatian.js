...
function initialize() {
		...
		document.getElementById("wkk_tx").style.textAlign= 'left';
			if(keyBoardType == 0 ) { 
				miniPopUpInfoObjects[0] = getPopUPInfoObject("11", "wkk_key_02", "02", new Array('c','ć','č'), new Array("00","01","02"), null, "03");
				miniPopUpInfoObjects[1] = getPopUPInfoObject("10", "wkk_key_02", "02", new Array('C','Ć','Č'), new Array("00","01","02"), null, "03");
				miniPopUpInfoObjects[2] = getPopUPInfoObject("11", "wkk_key_03", "04", new Array('d','ð'), new Array("00","01"), null, "02");
				miniPopUpInfoObjects[3] = getPopUPInfoObject("10", "wkk_key_03", "04", new Array('D','Ð'), new Array("00","01"), null, "02");
				...
				miniPopUpInfoObjects[0] = getPopUPInfoObject("11", "wkk_key_003", "02", new Array('c','ć','č'), new Array("00","01","02"), null, "03");
				miniPopUpInfoObjects[1] = getPopUPInfoObject("10", "wkk_key_003", "02", new Array('C','Ć','Č'), new Array("00","01","02"), null, "03");
				miniPopUpInfoObjects[2] = getPopUPInfoObject("11", "wkk_key_004", "04", new Array('d','ð'), new Array("00","01"), null, "02");
				miniPopUpInfoObjects[3] = getPopUPInfoObject("10", "wkk_key_004", "04", new Array('D','Ð'), new Array("00","01"), null, "02");
	...
	if(keyBoardType==0){	
		if(gubun == 'lang'){	
		  ...
		  setInnerHtml("wkk_key_62", 'ABC');
			...
			setInnerHtml("wkk_key_61", "CRO");	//Lang Toggle
...
/*********************************************************************/
	...
	/*********************************************************************/	
		...
		if(gubun == 'lang'){
			...
			setInnerHtml("wkk_key_116", "CRO");	//Lang Toggle
