...
function initialize() {
	...
	if(keyBoardType==0){
		miniPopUpInfoObjects[0] = getPopUPInfoObject("11", "wkk_key_00", "05", new Array('a','á','å','æ'), new Array("00","01","02","03"), null, "04");
		miniPopUpInfoObjects[1] = getPopUPInfoObject("10", "wkk_key_00", "05", new Array('A','Á','Å','Æ'), new Array("00","01","02","03"), null, "04");
		...
		miniPopUpInfoObjects[4] = getPopUPInfoObject("11", "wkk_key_24", "02", new Array('o','ó','ø'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[5] = getPopUPInfoObject("10", "wkk_key_24", "02", new Array('O','Ó','Ø'), new Array("00","01","02"), null, "03");
	} else if(keyBoardType==1){
		miniPopUpInfoObjects[0] = getPopUPInfoObject("11", "wkk_key_00", "05", new Array('a','á','å','æ'), new Array("00","01","02","03"), null, "04");
		miniPopUpInfoObjects[1] = getPopUPInfoObject("10", "wkk_key_00", "05", new Array('A','Á','Å','Æ'), new Array("00","01","02","03"), null, "04");
		miniPopUpInfoObjects[2] = getPopUPInfoObject("11", "wkk_key_04", "04", new Array('e','é'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[3] = getPopUPInfoObject("10", "wkk_key_04", "04", new Array('E','É'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[4] = getPopUPInfoObject("11", "wkk_key_22", "02", new Array('o','ó','ø'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[5] = getPopUPInfoObject("10", "wkk_key_22", "02", new Array('O','Ó','Ø'), new Array("00","01","02"), null, "03");

	} else{
		miniPopUpInfoObjects[0] = getPopUPInfoObject("11", "wkk_key_001", "05", new Array('a','á','å','æ'), new Array("00","01","02","03"), null, "04");
		miniPopUpInfoObjects[1] = getPopUPInfoObject("10", "wkk_key_001", "05", new Array('A','Á','Å','Æ'), new Array("00","01","02","03"), null, "04");
		...
		miniPopUpInfoObjects[4] = getPopUPInfoObject("11", "wkk_key_102", "02", new Array('o','ó','ø'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[5] = getPopUPInfoObject("10", "wkk_key_102", "02", new Array('O','Ó','Ø'), new Array("00","01","02"), null, "03");
...
function changeKeyValue(gubun) {
	...
	if(keyBoardType==0){	
		if(gubun == 'lang'){	
		  ...
		  setInnerHtml("wkk_key_62", 'ABC');
			...
			setInnerHtml("wkk_key_61", "DAN");	//Lang Toggle
	...
	/*********************************************************************/	
		...
		if(gubun == 'lang'){
			...
			setInnerHtml("wkk_key_116", "DAN");	//Lang Toggle
