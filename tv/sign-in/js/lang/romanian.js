...
function initialize() {
	...
	if(keyBoardType==0){
		miniPopUpInfoObjects[0] = getPopUPInfoObject("11", "wkk_key_00", "02", new Array('a','â','ă'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[1] = getPopUPInfoObject("10", "wkk_key_00", "02", new Array('A','Â','Ă'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[2] = getPopUPInfoObject("11", "wkk_key_13", "04", new Array('i','î'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[3] = getPopUPInfoObject("10", "wkk_key_13", "04", new Array('I','Î'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[4] = getPopUPInfoObject("11", "wkk_key_33", "04", new Array('s','ş'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[5] = getPopUPInfoObject("10", "wkk_key_33", "04", new Array('S','Ş'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[6] = getPopUPInfoObject("11", "wkk_key_34", "04", new Array('t','ţ'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[7] = getPopUPInfoObject("10", "wkk_key_34", "04", new Array('T','Ţ'), new Array("00","01"), null, "02");
	} else if(keyBoardType==1){
		miniPopUpInfoObjects[0] = getPopUPInfoObject("11", "wkk_key_00", "02", new Array('a','â','ă'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[1] = getPopUPInfoObject("10", "wkk_key_00", "02", new Array('A','Â','Ă'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[2] = getPopUPInfoObject("11", "wkk_key_12", "04", new Array('i','î'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[3] = getPopUPInfoObject("10", "wkk_key_12", "04", new Array('I','Î'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[4] = getPopUPInfoObject("11", "wkk_key_30", "04", new Array('s','ş'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[5] = getPopUPInfoObject("10", "wkk_key_30", "04", new Array('S','Ş'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[6] = getPopUPInfoObject("11", "wkk_key_31", "04", new Array('t','ţ'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[7] = getPopUPInfoObject("10", "wkk_key_31", "04", new Array('T','Ţ'), new Array("00","01"), null, "02");

	} else{
		miniPopUpInfoObjects[0] = getPopUPInfoObject("11", "wkk_key_001", "02", new Array('a','â','ă'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[1] = getPopUPInfoObject("10", "wkk_key_001", "02", new Array('A','Â','Ă'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[2] = getPopUPInfoObject("11", "wkk_key_009", "04", new Array('i','î'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[3] = getPopUPInfoObject("10", "wkk_key_009", "04", new Array('I','Î'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[4] = getPopUPInfoObject("11", "wkk_key_106", "04", new Array('s','ş'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[5] = getPopUPInfoObject("10", "wkk_key_106", "04", new Array('S','Ş'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[6] = getPopUPInfoObject("11", "wkk_key_107", "04", new Array('t','ţ'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[7] = getPopUPInfoObject("10", "wkk_key_107", "04", new Array('T','Ţ'), new Array("00","01"), null, "02");
...
function changeKeyValue(gubun) {
	...
	if(keyBoardType==0){	
		if(gubun == 'lang'){	
		  ...
		  setInnerHtml("wkk_key_62", 'ABC');
			...
			setInnerHtml("wkk_key_61", "RUM");	//Lang Toggle
	...
	/*********************************************************************/	
		...
		if(gubun == 'lang'){
			...
			setInnerHtml("wkk_key_116", "RUM");	//Lang Toggle
