...
function initialize() {
	...
	if(keyBoardType==0){
		...
		miniPopUpInfoObjects[6] = getPopUPInfoObject("11", "wkk_key_24", "03", new Array('o','ó','õ','ö','ő'), new Array("00","01","02","10","11"), null, "12");
		miniPopUpInfoObjects[7] = getPopUPInfoObject("10", "wkk_key_24", "03", new Array('O','Ó','Õ','Ö','Ő'), new Array("00","01","02","10","11"), null, "12");
		miniPopUpInfoObjects[8] = getPopUPInfoObject("11", "wkk_key_40", "05", new Array('u','ú','ü','ű'), new Array("00","01","02","03"), null, "04");
		miniPopUpInfoObjects[9] = getPopUPInfoObject("10", "wkk_key_40", "05", new Array('U','Ú','Ü','Ű'), new Array("00","01","02","03"), null, "04");	
		...
		miniPopUpInfoObjects[6] = getPopUPInfoObject("11", "wkk_key_22", "03", new Array('o','ó','õ','ö','ő'), new Array("00","01","02","10","11"), null, "12");
		miniPopUpInfoObjects[7] = getPopUPInfoObject("10", "wkk_key_22", "03", new Array('O','Ó','Õ','Ö','Ő'), new Array("00","01","02","10","11"), null, "12");
		miniPopUpInfoObjects[8] = getPopUPInfoObject("11", "wkk_key_32", "05", new Array('u','ú','ü','ű'), new Array("00","01","02","03"), null, "04");
		miniPopUpInfoObjects[9] = getPopUPInfoObject("10", "wkk_key_32", "05", new Array('U','Ú','Ü','Ű'), new Array("00","01","02","03"), null, "04");	
		...
		miniPopUpInfoObjects[6] = getPopUPInfoObject("11", "wkk_key_102", "03", new Array('o','ó','õ','ö','ő'), new Array("00","01","02","03","04"), null, "05");
		miniPopUpInfoObjects[7] = getPopUPInfoObject("10", "wkk_key_102", "03", new Array('O','Ó','Õ','Ö','Ő'), new Array("00","01","02","03","04"), null, "05");
		miniPopUpInfoObjects[8] = getPopUPInfoObject("11", "wkk_key_108", "05", new Array('u','ú','ü','ű'), new Array("00","01","02","03"), null, "04");
		miniPopUpInfoObjects[9] = getPopUPInfoObject("10", "wkk_key_108", "05", new Array('U','Ú','Ü','Ű'), new Array("00","01","02","03"), null, "04");	
...
function changeKeyValue(gubun) {
	...
	if(keyBoardType==0){	
		if(gubun == 'lang'){	
		  ...
		  setInnerHtml("wkk_key_62", 'ABC');
			...
			setInnerHtml("wkk_key_61", "HUN");	//Lang Toggle
	...
	/*********************************************************************/	
		...
		if(gubun == 'lang'){
			...
			setInnerHtml("wkk_key_116", "HUN");	//Lang Toggle
