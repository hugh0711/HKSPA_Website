...
function initialize() {
		...
		if(keyBoardType == 0 ) { 
		miniPopUpInfoObjects[0] = getPopUPInfoObject("11", "wkk_key_02", "04", new Array('c','č'), new Array("00","01","02"), null, "02");
		miniPopUpInfoObjects[1] = getPopUPInfoObject("10", "wkk_key_02", "04", new Array('C','Č'), new Array("00","01","02"), null, "02");
		miniPopUpInfoObjects[2] = getPopUPInfoObject("11", "wkk_key_24", "03", new Array('o','ò','ó','ô','ø'),new Array("00","01","02","10","11"), null, "12");
		miniPopUpInfoObjects[3] = getPopUPInfoObject("10", "wkk_key_24", "03", new Array('O','Ò','Ó','Ô','Ø'),new Array("00","01","02","10","11"), null, "12");
		miniPopUpInfoObjects[4] = getPopUPInfoObject("11", "wkk_key_33", "04", new Array('s','š'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[5] = getPopUPInfoObject("10", "wkk_key_33", "04", new Array('S','Š'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[6] = getPopUPInfoObject("11", "wkk_key_45", "04", new Array('z','ž'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[7] = getPopUPInfoObject("10", "wkk_key_45", "04", new Array('Z','Ž'), new Array("00","01"), null, "02");
	}else if(keyBoardType == 1){
		miniPopUpInfoObjects[0] = getPopUPInfoObject("11", "wkk_key_02", "04", new Array('c','č'), new Array("00","01","02"), null, "02");
		miniPopUpInfoObjects[1] = getPopUPInfoObject("10", "wkk_key_02", "04", new Array('C','Č'), new Array("00","01","02"), null, "02");
		miniPopUpInfoObjects[2] = getPopUPInfoObject("11", "wkk_key_22", "03", new Array('o','ò','ó','ô','ø'),new Array("00","01","02","10","11"), null, "12");
		miniPopUpInfoObjects[3] = getPopUPInfoObject("10", "wkk_key_22", "03", new Array('O','Ò','Ó','Ô','Ø'),new Array("00","01","02","10","11"), null, "12");
		miniPopUpInfoObjects[4] = getPopUPInfoObject("11", "wkk_key_30", "04", new Array('s','š'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[5] = getPopUPInfoObject("10", "wkk_key_30", "04", new Array('S','Š'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[6] = getPopUPInfoObject("11", "wkk_key_41", "04", new Array('z','ž'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[7] = getPopUPInfoObject("10", "wkk_key_41", "04", new Array('Z','Ž'), new Array("00","01"), null, "02");
	}else{
		miniPopUpInfoObjects[0] = getPopUPInfoObject("11", "wkk_key_003", "04", new Array('c','č'), new Array("00","01","02"), null, "02");
		miniPopUpInfoObjects[1] = getPopUPInfoObject("10", "wkk_key_003", "04", new Array('C','Č'), new Array("00","01","02"), null, "02");
		miniPopUpInfoObjects[2] = getPopUPInfoObject("11", "wkk_key_102", "03", new Array('o','ò','ó','ô','ø'),new Array("00","01","02","03","04"), null, "05");
		miniPopUpInfoObjects[3] = getPopUPInfoObject("10", "wkk_key_102", "03", new Array('O','Ò','Ó','Ô','Ø'),new Array("00","01","02","03","04"), null, "05");
		miniPopUpInfoObjects[4] = getPopUPInfoObject("11", "wkk_key_106", "04", new Array('s','š'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[5] = getPopUPInfoObject("10", "wkk_key_106", "04", new Array('S','Š'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[6] = getPopUPInfoObject("11", "wkk_key_113", "04", new Array('z','ž'), new Array("00","01"), null, "02");
		miniPopUpInfoObjects[7] = getPopUPInfoObject("10", "wkk_key_113", "04", new Array('Z','Ž'), new Array("00","01"), null, "02");
	}
}
	...
	if(keyBoardType==0){	
		if(gubun == 'lang'){	
		  ...
		  setInnerHtml("wkk_key_62", 'ABC');
			...
			setInnerHtml("wkk_key_61", "SLO");	//Lang Toggle
...
/*********************************************************************/
	...
	/*********************************************************************/	
		...
		if(gubun == 'lang'){
			...
			setInnerHtml("wkk_key_116", "SLO");	//Lang Toggle
