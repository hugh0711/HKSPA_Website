...
function initialize() {
	...
	if(keyBoardType==0){
		miniPopUpInfoObjects[0] = getPopUPInfoObject("11", "wkk_key_00", "02", new Array('a','ä','å'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[1] = getPopUPInfoObject("10", "wkk_key_00", "02", new Array('A','Ä','Å'), new Array("00","01","02"), null, "03");
		...
		miniPopUpInfoObjects[0] = getPopUPInfoObject("11", "wkk_key_001", "02", new Array('a','ä','å'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[1] = getPopUPInfoObject("10", "wkk_key_001", "02", new Array('A','Ä','Å'), new Array("00","01","02"), null, "03");
...
function changeKeyValue(gubun) {
	...
	if(keyBoardType==0){	
		if(gubun == 'lang'){	
		  ...
		  setInnerHtml("wkk_key_62", 'ABC');
			...
			setInnerHtml("wkk_key_61", "FIN");	//Lang Toggle
	...
	/*********************************************************************/	
		...
		if(gubun == 'lang'){
			...
			setInnerHtml("wkk_key_116", "FIN");	//Lang Toggle
