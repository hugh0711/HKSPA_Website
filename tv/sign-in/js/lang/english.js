...
var TITLE_LABEL = "Search Now!";
var DESC_LABEL = "Use the screen keyboard on the right to type just like you text by your keyboard.\n\n";
...
/*********************************************************************/
	if(keyBoardType==0){	
		...
		//	alert(">>>>>>>>>>>>>lagnTogglIdx : " + lagnTogglIdx);
			
			setInnerHtml("wkk_key_61", "ENG");	//Lang Toggle
...
/*********************************************************************/
	...
	/*********************************************************************/	
		...
		if(gubun == 'lang'){
			...
			//lagnTogglIdx = 9;
			setInnerHtml("wkk_key_116", "ENG");	//Lang Toggle
