...
function initialize() {
	...
	if(keyBoardType==0){
		miniPopUpInfoObjects[0] = getPopUPInfoObject("11", "wkk_key_00", "03", new Array('a','à','á','â','ã'), new Array("00","01","02","10","11"), null, "12");
		miniPopUpInfoObjects[1] = getPopUPInfoObject("10", "wkk_key_00", "03", new Array('A','À','Á','Â','Ã'), new Array("00","01","02","10","11"), null, "12");
		...
		miniPopUpInfoObjects[4] = getPopUPInfoObject("11", "wkk_key_04", "02", new Array('e','é','ê'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[5] = getPopUPInfoObject("10", "wkk_key_04", "02", new Array('E','É','Ê'), new Array("00","01","02"), null, "03");
		...
		miniPopUpInfoObjects[8] = getPopUPInfoObject("11", "wkk_key_24", "03", new Array('o','ó','ô','õ'," "), new Array("00","01","02","10","11"), null, "12");
		miniPopUpInfoObjects[9] = getPopUPInfoObject("10", "wkk_key_24", "03", new Array('O','Ó','Ô','Õ'," "), new Array("00","01","02","10","11"), null, "12");
		miniPopUpInfoObjects[10] = getPopUPInfoObject("11", "wkk_key_40", "02", new Array('u','ú','ü'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[11] = getPopUPInfoObject("10", "wkk_key_40", "02", new Array('U','Ú','Ü'), new Array("00","01","02"), null, "03");
		...
		miniPopUpInfoObjects[8] = getPopUPInfoObject("11", "wkk_key_22", "03", new Array('o','ó','ô','õ'," "), new Array("00","01","02","10","11"), null, "12");
		miniPopUpInfoObjects[9] = getPopUPInfoObject("10", "wkk_key_22", "03", new Array('O','Ó','Ô','Õ'," "), new Array("00","01","02","10","11"), null, "12");
		miniPopUpInfoObjects[10] = getPopUPInfoObject("11", "wkk_key_32", "02", new Array('u','ú','ü'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[11] = getPopUPInfoObject("10", "wkk_key_32", "02", new Array('U','Ú','Ü'), new Array("00","01","02"), null, "03");
	} else{
		miniPopUpInfoObjects[0] = getPopUPInfoObject("11", "wkk_key_001", "03", new Array('a','à','á','â','ã'), new Array("00","01","02","03","04"), null, "05");
		miniPopUpInfoObjects[1] = getPopUPInfoObject("10", "wkk_key_001", "03", new Array('A','À','Á','Â','Ã'), new Array("00","01","02","03","04"), null, "05");
		...
		miniPopUpInfoObjects[4] = getPopUPInfoObject("11", "wkk_key_005", "02", new Array('e','é','ê'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[5] = getPopUPInfoObject("10", "wkk_key_005", "02", new Array('E','É','Ê'), new Array("00","01","02"), null, "03");
		...
		miniPopUpInfoObjects[8] = getPopUPInfoObject("11", "wkk_key_102", "05", new Array('o','ó','ô','õ'), new Array("00","01","02","03"), null, "04");
		miniPopUpInfoObjects[9] = getPopUPInfoObject("10", "wkk_key_102", "05", new Array('O','Ó','Ô','Õ'), new Array("00","01","02","03"), null, "04");
		miniPopUpInfoObjects[10] = getPopUPInfoObject("11", "wkk_key_108", "02", new Array('u','ú','ü'), new Array("00","01","02"), null, "03");
		miniPopUpInfoObjects[11] = getPopUPInfoObject("10", "wkk_key_108", "02", new Array('U','Ú','Ü'), new Array("00","01","02"), null, "03");
	}
}
...
function changeKeyValue(gubun) {
	...
	if(keyBoardType==0){	
		if(gubun == 'lang'){	
		  ...
		  setInnerHtml("wkk_key_62", 'ABC');
			...
			setInnerHtml("wkk_key_61", "POR");	//Lang Toggle
	...
	/*********************************************************************/	
		...
		if(gubun == 'lang'){
			...
			setInnerHtml("wkk_key_116", "POR");	//Lang Toggle
