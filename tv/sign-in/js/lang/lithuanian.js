...
function initialize() {
		...
		if(keyBoardType == 0 ) {
			...
			miniPopUpInfoObjects[4] = getPopUPInfoObject("11", "wkk_key_04", "02", new Array('e','ę','ė'), new Array("00","01","02"), null, "03");
			miniPopUpInfoObjects[5] = getPopUPInfoObject("10", "wkk_key_04", "02", new Array('E','Ę','Ė'), new Array("00","01","02"), null, "03");
			miniPopUpInfoObjects[6] = getPopUPInfoObject("11", "wkk_key_13", "04", new Array('i','į'), new Array("00","01"), null, "02");
			miniPopUpInfoObjects[7] = getPopUPInfoObject("10", "wkk_key_13", "04", new Array('I','Į'), new Array("00","01"), null, "02");
			miniPopUpInfoObjects[8] = getPopUPInfoObject("11", "wkk_key_33", "04", new Array('s','š'), new Array("00","01"), null, "02");
			miniPopUpInfoObjects[9] = getPopUPInfoObject("10", "wkk_key_33", "04", new Array('S','Š'), new Array("00","01"), null, "02");
			miniPopUpInfoObjects[10] = getPopUPInfoObject("11", "wkk_key_40", "02", new Array('u','ų','ū'), new Array("00","01","02"), null, "03");
			miniPopUpInfoObjects[11] = getPopUPInfoObject("10", "wkk_key_40", "02", new Array('U','Ų','Ū'), new Array("00","01","02"), null, "03");
			miniPopUpInfoObjects[12] = getPopUPInfoObject("11", "wkk_key_45", "04", new Array('z','ž'), new Array("00","01"), null, "02");
			miniPopUpInfoObjects[13] = getPopUPInfoObject("10", "wkk_key_45", "04", new Array('Z','Ž'), new Array("00","01"), null, "02");
			...
			miniPopUpInfoObjects[4] = getPopUPInfoObject("11", "wkk_key_04", "02", new Array('e','ę','ė'), new Array("00","01","02"), null, "03");
			miniPopUpInfoObjects[5] = getPopUPInfoObject("10", "wkk_key_04", "02", new Array('E','Ę','Ė'), new Array("00","01","02"), null, "03");
			miniPopUpInfoObjects[6] = getPopUPInfoObject("11", "wkk_key_12", "04", new Array('i','į'), new Array("00","01"), null, "02");
			miniPopUpInfoObjects[7] = getPopUPInfoObject("10", "wkk_key_12", "04", new Array('I','Į'), new Array("00","01"), null, "02");
			miniPopUpInfoObjects[8] = getPopUPInfoObject("11", "wkk_key_30", "04", new Array('s','š'), new Array("00","01"), null, "02");
			miniPopUpInfoObjects[9] = getPopUPInfoObject("10", "wkk_key_30", "04", new Array('S','Š'), new Array("00","01"), null, "02");
			miniPopUpInfoObjects[10] = getPopUPInfoObject("11", "wkk_key_32", "02", new Array('u','ų','ū'), new Array("00","01","02"), null, "03");
			miniPopUpInfoObjects[11] = getPopUPInfoObject("10", "wkk_key_32", "02", new Array('U','Ų','Ū'), new Array("00","01","02"), null, "03");
			miniPopUpInfoObjects[12] = getPopUPInfoObject("11", "wkk_key_41", "04", new Array('z','ž'), new Array("00","01"), null, "02");
			miniPopUpInfoObjects[13] = getPopUPInfoObject("10", "wkk_key_41", "04", new Array('Z','Ž'), new Array("00","01"), null, "02");
		}else{
			...
			miniPopUpInfoObjects[4] = getPopUPInfoObject("11", "wkk_key_005", "02", new Array('e','ę','ė'), new Array("00","01","02"), null, "03");
			miniPopUpInfoObjects[5] = getPopUPInfoObject("10", "wkk_key_005", "02", new Array('E','Ę','Ė'), new Array("00","01","02"), null, "03");
			miniPopUpInfoObjects[6] = getPopUPInfoObject("11", "wkk_key_009", "04", new Array('i','į'), new Array("00","01"), null, "02");
			miniPopUpInfoObjects[7] = getPopUPInfoObject("10", "wkk_key_009", "04", new Array('I','Į'), new Array("00","01"), null, "02");
			miniPopUpInfoObjects[8] = getPopUPInfoObject("11", "wkk_key_106", "04", new Array('s','š'), new Array("00","01"), null, "02");
			miniPopUpInfoObjects[9] = getPopUPInfoObject("10", "wkk_key_106", "04", new Array('S','Š'), new Array("00","01"), null, "02");
			miniPopUpInfoObjects[10] = getPopUPInfoObject("11", "wkk_key_108", "02", new Array('u','ų','ū'), new Array("00","01","02"), null, "03");
			miniPopUpInfoObjects[11] = getPopUPInfoObject("10", "wkk_key_108", "02", new Array('U','Ų','Ū'), new Array("00","01","02"), null, "03");
			miniPopUpInfoObjects[12] = getPopUPInfoObject("11", "wkk_key_113", "04", new Array('z','ž'), new Array("00","01"), null, "02");
			miniPopUpInfoObjects[13] = getPopUPInfoObject("10", "wkk_key_113", "04", new Array('Z','Ž'), new Array("00","01"), null, "02");
		}
}
...
if(keyBoardType==0){	
		if(gubun == 'lang'){	
		  ...
		  setInnerHtml("wkk_key_62", 'ABC');
			...
			setInnerHtml("wkk_key_61", "LIT");	//Lang Toggle
...
/*********************************************************************/
	...
	/*********************************************************************/	
		...
		if(gubun == 'lang'){
			...
			setInnerHtml("wkk_key_116", "LIT");	//Lang Toggle
