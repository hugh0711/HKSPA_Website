...
function initialize() {
		...
		if(keyBoardType == 0 ) {
			miniPopUpInfoObjects[0] = getPopUPInfoObject("11", "wkk_key_02", "02", new Array('c','ć','ĉ'), new Array("00","01","02"), null, "03");
			miniPopUpInfoObjects[1] = getPopUPInfoObject("10", "wkk_key_02", "02", new Array('C','Ć','Ĉ'), new Array("00","01","02"), null, "03");
			...
			miniPopUpInfoObjects[0] = getPopUPInfoObject("11", "wkk_key_003", "02", new Array('c','ć','ĉ'), new Array("00","01","02"), null, "03");
			miniPopUpInfoObjects[1] = getPopUPInfoObject("10", "wkk_key_003", "02", new Array('C','Ć','Ĉ'), new Array("00","01","02"), null, "03");
	...
	if(keyBoardType==0){	
		if(gubun == 'lang'){	
		  ...
		  setInnerHtml("wkk_key_62", 'ABC');
			...
			setInnerHtml("wkk_key_61", "BOS");	//Lang Toggle
...
/*********************************************************************/
	...
	/*********************************************************************/	
		...
		if(gubun == 'lang'){			
			...
			setInnerHtml("wkk_key_116", "BOS");	//Lang Toggle
