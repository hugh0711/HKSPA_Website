...
function initialize() {
			...
			if(keyBoardType == 0 ) { 
				...
				miniPopUpInfoObjects[2] = getPopUPInfoObject("11", "wkk_key_24", "02", new Array('o','õ','ö'), new Array("00","01","02"), null, "03");
				miniPopUpInfoObjects[3] = getPopUPInfoObject("10", "wkk_key_24", "02", new Array('O','Õ','Ö'), new Array("00","01","02"), null, "03");
				...
				miniPopUpInfoObjects[8] = getPopUPInfoObject("11", "wkk_key_45", "04", new Array('z','ž'), new Array("00","01"), null, "02");
				miniPopUpInfoObjects[9] = getPopUPInfoObject("10", "wkk_key_45", "04", new Array('Z','Ž'), new Array("00","01"), null, "02");
			}else if(keyBoardType == 1 ) { 
				miniPopUpInfoObjects[0] = getPopUPInfoObject("11", "wkk_key_00", "04", new Array('a','ä'), new Array("00","01"), null, "02");
				miniPopUpInfoObjects[1] = getPopUPInfoObject("10", "wkk_key_00", "04", new Array('A','Ä'), new Array("00","01"), null, "02");
				miniPopUpInfoObjects[2] = getPopUPInfoObject("11", "wkk_key_22", "02", new Array('o','õ','ö'), new Array("00","01","02"), null, "03");
				miniPopUpInfoObjects[3] = getPopUPInfoObject("10", "wkk_key_22", "02", new Array('O','Õ','Ö'), new Array("00","01","02"), null, "03");
				...
				miniPopUpInfoObjects[8] = getPopUPInfoObject("11", "wkk_key_41", "04", new Array('z','ž'), new Array("00","01"), null, "02");
				miniPopUpInfoObjects[9] = getPopUPInfoObject("10", "wkk_key_41", "04", new Array('Z','Ž'), new Array("00","01"), null, "02");				
			}else{
				...
				miniPopUpInfoObjects[2] = getPopUPInfoObject("11", "wkk_key_102", "02", new Array('o','õ','ö'), new Array("00","01","02"), null, "03");
				miniPopUpInfoObjects[3] = getPopUPInfoObject("10", "wkk_key_102", "02", new Array('O','Õ','Ö'), new Array("00","01","02"), null, "03");
				...
				miniPopUpInfoObjects[8] = getPopUPInfoObject("11", "wkk_key_113", "04", new Array('z','ž'), new Array("00","01"), null, "02");
				miniPopUpInfoObjects[9] = getPopUPInfoObject("10", "wkk_key_113", "04", new Array('Z','Ž'), new Array("00","01"), null, "02");				
			}
}
	...
	if(keyBoardType==0){	
		if(gubun == 'lang'){	
		  ...
		  setInnerHtml("wkk_key_62", 'ABC');
			...
			setInnerHtml("wkk_key_61", "EST");	//Lang Toggle
...
/*********************************************************************/
	...
	/*********************************************************************/	
		...
		if(gubun == 'lang'){
			...
			setInnerHtml("wkk_key_116", "EST");	//Lang Toggle
