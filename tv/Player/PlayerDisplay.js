...
PlayerDisplay.setTotalTime = function(total)
{
    this.totalTime = total;
}

PlayerDisplay.setTime = function(time)
{
    ...
    this.TimeString = timeHTML ;
	//alert("TimeString"+ this.TimeString);
	//document.getElementById('timer').innerHTML = timeHTML;
    
}

PlayerDisplay.status = function(status)
{
    alert(status);
	
    //setInnerHtml(document.getElementById("mainNavItemText0"), status);
    setInnerHtml(this.statusDiv, status);
}


PlayerDisplay.setVolume = function(level)
{
/*
...
/*
PlayerDisplay.setVideoList = function(nameList)
{
    var listHTML = "";
...
PlayerDisplay.setVideoListPosition = function(position, move)
{    
    var listHTML = "";
...
PlayerDisplay.setDescription = function(description)
{
...
PlayerDisplay.hide = function()
{
    document.getElementById("main").style.display="none";
}

PlayerDisplay.show = function()
{
